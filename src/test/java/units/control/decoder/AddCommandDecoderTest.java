...
class AddCommandDecoderTest {
    ...
    void decode_shouldReturnInstructions_whenValidArgs() {
        ...
        // 2 gültige InstructionValues: einer mit Address, einer mit Word
        ...
        assertEquals(4, instructions.length); // Get, SetStoredValue, SetValue, UnitInstruction
        assertEquals("add", instructions[3].getKeyword());
    }
